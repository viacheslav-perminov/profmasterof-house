			...
			<div class="house-card__row">
						...
						<div class="house-card__slider-main swiper">
							<div class="swiper-wrapper">
								...
								<?php foreach($images as $image): ?>
									...
									<a href="<?= $image['ID'] ?>" class="swiper-slide" data-fancybox="gallery-house-card">
				...
				<div class="house-card__info">
					...
					<div class="house-card__links">
						...
						<?php if ($field = get_field('file')): ?>
							<a href="<?= $field['url'] ?>" class="house-card__btn btn btn--transparent" download>Смотреть комплектацию</a>
						<?php endif ?>
					...
					<div class="tabs__slider swiper">
						<div class="swiper-wrapper">
							...
							<?php while ($wp_query->have_posts()): $wp_query->the_post(); ?>
								<?php get_template_part('parts/content', 'project', ['is_slider' => true]) ?>
							<?php endwhile; ?>
